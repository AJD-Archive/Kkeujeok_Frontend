...
const Navbar = () => {
  ...
  return (
    <S.NavBarLayout>
      <div>
        <S.UserInfoContainer>
          <Profile height='50px' profile={UserInfo?.data.picture} width='50px' />
          <StyledLink to='/mypage'>
            <S.UserDetailContainer>
              ...
              {/* 닉네임을 atom에서 가져와 출력 */}
              <Link to='/mypage'>
                마이페이지 <img alt='마이페이지 이동 화살표' src={rightarrow} />
              </Link>
            </S.UserDetailContainer>
          </StyledLink>
        </S.UserInfoContainer>
      ...
      <S.DashboardsContainer>
        <Dashboard dashboard={dashboard?.data.personalDashboardListResDto} text='개인' />
        <Dashboard dashboard={teamDashboard?.data.teamDashboardInfoResDto} text='팀' />
      </S.DashboardsContainer>
